...
cd into the directory through the terminal 
To call: python3 projectx.py 
Read the options and choose 2,3,4,5,6,7, or 8 to obtain a list of interesting anagrams or choose 1 to receive a list of all anagrams.
